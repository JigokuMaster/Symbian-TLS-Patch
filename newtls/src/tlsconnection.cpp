 ...
 */
{
	LOG("CTlsConnection::~CTlsConnection()");
	if (iHandshake) {
		delete iHandshake;
		iHandshake = NULL;
	}
 ...
 */
{
	LOG("CTlsConnection::ConstructL(1)");
 ...
 */
{
	LOG("CTlsConnection::ConstructL(2)");
	CActiveScheduler::Add(this);
...
{
	LOG("CTlsConnection::RunL()");
	CActiveScheduler::Stop();
}

void CTlsConnection::DoCancel()
{
	LOG("CTlsConnection::DoCancel()");
}
...
{
	// ignored
	LOG("CTlsConnection::AvailableCipherSuites()");
	return KErrNone;
}
 ...
 */
{
	LOG("CTlsConnection::CancelHandshake()");
	CancelAll();
}
 ...
 */
{
	LOG("CTlsConnection::ClientCertMode()");
...
{
	// stub
	LOG("CTlsConnection::CurrentCipherSuite()");
...
{
	// TODO session cache
	LOG("CTlsConnection::FlushSessionCache()");
}
 ...
 */
{
	LOG("CTlsConnection::GetOpt(1): %d %d", aOptionName, aOptionLevel);
 ...
 */
{
	LOG("CTlsConnection::RenegotiateHandshake()");
 ...
 */
{
	LOG("CTlsConnection::SetAvailableCipherSuites()");
	return KErrNone;
}
 ...
 */
{
	LOG("CTlsConnection::SetClientCert()");
	return KErrNone;
}
 ...
 */
{
	LOG("CTlsConnection::SetClientCertMode()");
	return KErrNone;
}
 ...
 */
{
	LOG("CTlsConnection::SetDialogMode()");
	return KErrNone;
}
 ...
 */
{
	LOG("CTlsConnection::SetOpt(): name: %x, level: %x", aOptionName, aOptionLevel);
...
{
	// ignored
	LOG("CTlsConnection::SetProtocol()");
	return KErrNone;
}
 ...
 */
{
	LOG("CTlsConnection::SetServerCert()");
 ...
 */
{
	LOG("CTlsConnection::StartClientHandshake()");
	TRequestStatus* pStatus = &aStatus;
 ...
 */
{
	LOG("CTlsConnection::StartServerHandshake()");
	TRequestStatus* pStatus = &aStatus;
...
{
	LOG("CTlsConnection::OnCompletion()");
 ...
 */
{
	...
	if (iSendingData) {
		LOG("CTlsConnection::Send(1) Busy");
		User::RequestComplete(pStatus, KErrInUse);
		return EFalse;
	}
	LOG("CTlsConnection::Send(1)");
	if (!iHandshaked) {
 ...
 */
{
	...
	if (iReceivingData) {
		LOG("CTlsConnection::RecvOneOrMore() Busy");
		User::RequestComplete(pStatus, KErrInUse);
		return EFalse;
	}
